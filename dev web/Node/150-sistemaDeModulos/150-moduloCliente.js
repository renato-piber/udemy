...
const moduloA = require('./150-moduloA') // ./ é para acessar um modulo na mesma pasta = caminho relativo 
const moduloB = require('./150-moduloB') // o padrao de importacao é arquivos .js, apenas arquivos de outras extensoes que precisam ser especificados
